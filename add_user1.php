<?php
// Assuming you're logged in as an admin, and the connection is already established
session_start();
require_once 'schema.php'; // Database connection
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $types = $_POST['types']; // Changed to 'types' for consistency
